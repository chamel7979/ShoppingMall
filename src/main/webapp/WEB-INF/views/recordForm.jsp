...
<table class="table table-bordered">
    <thead>
        <caption><div align="center" style=""> 글쓰기 </div></caption>
    </thead>
    <tbody>
        <form action="recordVisit" method="post" onsubmit="return check()" encType="multiplart/form-data">
            <tr>
                <th>제목 </th>
            ...
            <tr>
                <th>아이디 </th>
                <td><input type="text" readonly="readonly" value="${loginid }" name="custid" id="custid" class="form-control"/></td>
            </tr>
            <tr>
                <th>비밀번호 </th>
                <td><input type="password" placeholder="비밀번호를 입력하세요" name="pw" id="pw" class="form-control"/></td>
            </tr>
            <tr>
                <th>내용 </th>
                <td><textarea cols="10" rows="30" placeholder="내용을 입력하세요. " name="content" id="content" class="form-control"></textarea></td>
            </tr>
           <!--  <tr>
                <th>첨부파일 </th>
